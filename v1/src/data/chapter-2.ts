...
export const CHAPTER_2: readonly MigratedFact[] = [
  {
    id: "f220",
    tag: "UK definition",
    chapter: 2,
  ...
  },
  {
    ...
    chapter: 2,
    verify: true,
    question: "Roughly what UK population figure does the handbook give?",
    answer: "About 62 million",
    forms: [
    {
      question: "Roughly what UK population figure does the handbook give?",
      mcqOnly: false,
      answers: {
        kind: 'fixed',
        correct: "About 62 million",
        distractors: ["About 52 million", "About 42 million", "About 72 million"],
      },
      v0CorrectIndex: 3,
    },
    {
      question: "Roughly what was the population of the UK in 2010?",
      mcqOnly: false,
      answers: {
        kind: 'fixed',
        correct: "About 62 million",
        distractors: ["About 52 million", "About 78 million", "About 45 million"],
      },
      v0CorrectIndex: 3,
    },
    {
