  ...
  },
  {
    ...
    forms: [
      ...
      { question: 'Which statement about women in the UK today is correct?', mcqOnly: true,
        answers: { kind: 'fixed', correct: 'More women than men study at university', distractors: ['Women make up a tenth of the workforce', 'Fewer women than men complete school', 'Women are barred from senior management roles'] } },
    ],
  },
  {
  ...
  },
  {
    ...
    forms: [
      ...
      { question: 'Recycling reduces the amount of rubbish sent to which kind of site?', mcqOnly: false,
        answers: { kind: 'fixed', correct: 'Landfill', distractors: ['Reservoirs', 'Allotments', 'Nature reserves'] } },
  ...
  },
  {
    ...
    forms: [
      ...
      { question: 'Alongside pool, which game is traditionally played in British pubs?', mcqOnly: false,
        answers: { kind: 'fixed', correct: 'Darts', distractors: ['Chess', 'Bingo', 'Skittles'] } },
  ...
  // ==========================================================================
  {
    ...
    forms: [
      ...
      { question: 'A tenant and a landlord disagree about repairs to the property. Which area of law is this?', mcqOnly: false,
        answers: { kind: 'fixed', correct: 'Housing law', distractors: ['Criminal law', 'Company law', 'Family law'] } },
